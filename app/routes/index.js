...
// 찜목록 관련
const wishlist = require('../controller/Cwishlist');
galleryRouter.get('/wishlist', wishlist.categoryAllPage);
galleryRouter.get('/wishlist/exhibition', wishlist.categoryExhibition);
galleryRouter.get('/wishlist/artgallery', wishlist.categoryArtgallery);
galleryRouter.get('/wishlist/museum', wishlist.categoryMuseum);
galleryRouter.get('/wishlist/popupstore', wishlist.categoryPopup);
